...
<body>
	<div class="x-body">
		<form class="layui-form"
			action="${pageContext.request.contextPath}/ShujuzidianEdit?value=<%=request.getParameter("value") %>"
			method="post">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="name" required="" lay-verify="required">
						...
						<option class="layui-input" value="<%=name %>" lay-skin="primary"><%=name %></option>
					</select>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<% String value = request.getParameter("value"); %>
					<input type="text" id="value_back" name="value_back" required="" value="<%=value %>"
