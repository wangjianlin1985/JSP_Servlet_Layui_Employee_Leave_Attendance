	...
	<div class="layui-card">
		...
		<div class="x-body">
			...
			<button class="layui-btn"
				onclick="x_admin_show('添加员工','${pageContext.request.contextPath}/view/views/user/user/staff-add.jsp',600,400)">
					...
					<c:forEach items="${pageBean.staffList}" var="staff">
						<tr>
							...
							<td class="td-manage"><a onclick="member_stop(this,'10001')"
								...
								onclick="x_admin_show('编辑','${pageContext.request.contextPath}/view/views/user/user/staff-edit.jsp?id=${staff.id}',600,400)"
								href="javascript:void(0);"> <i class="layui-icon">&#xe642;</i>
							</a> <a title="删除" onclick="member_del('${staff.id}')"
								href="javascript:void(0);"> <i class="layui-icon">&#xe640;</i>
							</a></td>
						</tr>
					</c:forEach>
			...
			<div class="page">
				<div>
					...
					<c:if test="${pageBean.currentPage!=1 }">
						<a class="prev"
							href="${pageContext.request.contextPath }/StaffList?currentPage=${pageBean.currentPage-1 }">&lt;&lt;</a>
					</c:if>
			...
			layer
					.confirm(
							...
							function(index) {
								...
								setTimeout(
										function() {
											location.href = "${pageContext.request.contextPath}/StaffDel?id="
													+ id;
										}, 1000);
							});
		}
